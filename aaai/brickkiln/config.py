...
# ---------- PATH ROOTS ----------
base_path = "/home/rishabh.mondal/Brick-Kilns-project/ijcai_2025_kilns/data/processed_data"
delhi = f"{base_path}/delhi_airshed_120"
lucknow = f"{base_path}/lucknow_airshed_120"
...
exp1_train_delhi_test_lucknow = {
    "experiment_name": "exp1_train_delhi_test_lucknow",
    "train_images": f"{delhi}/train/images",
    "train_labels": f"{delhi}/train/labels_voc",
    "test_images": f"{lucknow}/test/images",
    "test_labels": f"{lucknow}/test/labels_voc"
}

# 2. Train on Delhi, Test on Delhi 
exp2_train_delhi_test_delhi = {
    "experiment_name": "exp2_train_delhi_test_delhi",
    "train_images": f"{delhi}/train/images",
    "train_labels": f"{delhi}/train/labels_voc",
    "test_images": f"{delhi}/test/images",
    "test_labels": f"{delhi}/test/labels_voc"
}

# 10. Train on  Lucknow, Test on  Lucknow
exp3_train_lucknow_test_lucknow = {
    "experiment_name": "exp3_train_lucknow_test_lucknow",
    "train_images": f"{lucknow}/train/images",
    "train_labels": f"{lucknow}/train/labels_voc",
    "test_images": f"{lucknow}/test/images",
    "test_labels": f"{lucknow}/test/labels_voc"
}

# 10. Train on Lucknow, Test on delhi
exp4_train_lucknow_test_lucknow = {
    "experiment_name": "exp4_train_lucknow_test_lucknow",
    "train_images": f"{lucknow}/train/images",
    "train_labels": f"{lucknow}/train/labels_voc",
    "test_images": f"{delhi}/test/images",
    "test_labels": f"{delhi}/test/labels_voc"
...
# # 9. Train on Lucknow, Test on Delhi
# exp1_train_lucknow_test_delhi = {
#     "experiment_name": "exp1_train_lucknow_test_delhi",
#     "train_images": f"{lucknow}/train/images",
#     "train_labels": f"{lucknow}/train/labels_voc",
#     "test_images": f"{delhi}/test/images",
#     "test_labels": f"{delhi}/test/labels_voc"
